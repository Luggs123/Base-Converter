...
public class bigIntAny {
	static BigInteger inputTotal = BigInteger.valueOf(0);
	...
	public static void partOne(){
		...
		for (int i = 0; i < inputDigits; i++) {
			switch (input.charAt(inputDigits - i - 1)){
				...
				default:System.out.println("Your number makes no sense. Terminating. Error code 4.");
						System.exit(4);
			}
		}
		System.out.println(input + " in base " + fromBase + " to base " + toBase + " is " + partTwo(toBase));
	}

	public static String partTwo(int toBase){
